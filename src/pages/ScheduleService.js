...
export default function ScheduleService() {
  ...
  const createOrder = async props => {
    const resp = await fetch(
      `${process.env.REACT_APP_URL_DATABASE}/schedule-service`,
      {
        method: "POST",
        headers: {
      ...
      case 0:
        return (
          <div style={{ textAlign: "left", fontSize: "14px" }}>
            Please choose an apporiate date and time at your convenience
          </div>
        );
      case 1:
        return (
          <div style={{ textAlign: "left" }}>
            <Container className="dateandtime_case1">
              <Row>
                <Col style={{ marginLeft: "2rem" }}>
                  ...
                  >
                    <img
                      src="http://www.getwash.in/images/sunrise.png"
                      alt="morning hour"
                    />
                    <div style={{ paddingLeft: "10px", paddingTop: "8px" }}>
                      ...
                      <p style={{ fontSize: "12px" }}>8am - 2pm</p>
                    </div>
                  </div>
                </Col>
                <Col>
                  ...
                  >
                    <img
                      src="http://www.getwash.in/images/sun.png"
                      alt="morning hour"
                    />
                    <div style={{ paddingLeft: "10px", paddingTop: "8px" }}>
                      <p>
                      ...
                      <p style={{ fontSize: "12px" }}>4pm - 10pm</p>
                    </div>
                  </div>
                </Col>
              </Row>
            ...
            <div class="time-selection-container">
              <input
                ...
                type="radio"
                name="time_radio"
                value="864616,2019-12-16"
                id="time1"
              />
              <label for="time1">
                <div className="timefrom">
                  <span>10:00 am</span>&nbsp; TO &nbsp;<span>01:00 pm</span>
                </div>
              </label>
            </div>
          </div>
      ...
      case 1:
        return (
          <div className="schedule_servicetype">
            ...
            <div
              className="schedule_main_service_row"
              style={{ display: "flex" }}
            >
                  ...
                  <div className="focusing" tabindex="1">
                    <label className="serv_was_box" for="serv1" id="step1_box">
                      ...
                      >
                        ...
                        <div className="text-sertype1" id="sertype1">
                          Wash &amp; Fold
                        </div>
                      </div>
                    </label>
            ...
            <div className="fleft fwidth date_main">
              ...
              >
                ...
                <label className="date-container" for="serv5" id="date5">
                  ...
                  <div className="date">Dec 21, 2019</div>
                </label>
              </div>
            </div>
